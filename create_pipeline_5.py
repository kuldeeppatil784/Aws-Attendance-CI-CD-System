...
pipeline = {
    "pipeline": {
        ...
        "roleArn": "arn:aws:iam::475432297908:role/AttendanceRole",
        "artifactStore": {
            "type": "S3",
            "location": "attendancecicdsource6389"
        },
        "stages": [
                ...
                "actions": [
                    {
                        ...
                        "runOrder": 1,
                        "configuration": {
                            "S3Bucket": "attendancecicdsource6389",
                            "S3ObjectKey": "app.zip",
                ...
                "actions": [
                    {
                        ...
                        "runOrder": 1,
                        "configuration": {
                            "BucketName": "attendancecicddeploy6389",
                            "Extract": "true"
                        },
                        "inputArtifacts": [
                            {"name": "BuildOutput"}
